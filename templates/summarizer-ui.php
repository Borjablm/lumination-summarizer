 ...
 *   $lumination_summarizer_is_auto, $lumination_summarizer_show_url,
 *   $lumination_summarizer_show_text, $lumination_summarizer_show_file
 *
...
$lumination_summarizer_is_auto  = ( 'auto' === $lms_mode );
$lumination_summarizer_show_url  = $lumination_summarizer_is_auto || 'url' === $lms_mode;
$lumination_summarizer_show_text = $lumination_summarizer_is_auto || 'text' === $lms_mode;
$lumination_summarizer_show_file = $lumination_summarizer_is_auto || 'file' === $lms_mode;
?>
<div class="lms-summarizer"
	...
	<div class="lms-input-section">
		...
		<?php if ( $lumination_summarizer_is_auto ) : ?>
		<!-- Mode tabs -->
		...
		<?php if ( $lumination_summarizer_show_url ) : ?>
		<!-- URL input -->
		<div class="lms-tab-panel lms-tab-panel--url<?php echo ( ! $lumination_summarizer_show_url || ( $lumination_summarizer_is_auto && 'url' !== $lms_mode ) ) ? '' : ''; ?>"
		...
		<?php if ( $lumination_summarizer_show_text ) : ?>
		<!-- Text input -->
		<div class="lms-tab-panel lms-tab-panel--text<?php echo ( $lumination_summarizer_is_auto || 'text' !== $lms_mode ) ? ' lms-hidden' : ''; ?>"
		...
		<?php if ( $lumination_summarizer_show_file ) : ?>
		<!-- File input -->
		<div class="lms-tab-panel lms-tab-panel--file<?php echo ( $lumination_summarizer_is_auto || 'file' !== $lms_mode ) ? ' lms-hidden' : ''; ?>"
